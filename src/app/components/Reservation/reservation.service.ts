  ...
  async sendEmail(books: any) {
    ...
    await fetch('https://library-fccj.herokuapp.com/mail', {
      ...
      body: JSON.stringify({
        ...
        message: '<html>,<br>Thank you for reserving a book. You have successfully reserved the book ' + books[0].title + ' and the return date is ' + books[0].returnDate.toLocaleDateString() + '.<br> Thank you.</html>'
      }),
      headers: {
        'Content-type': 'application/json; charset=UTF-8'
      }
